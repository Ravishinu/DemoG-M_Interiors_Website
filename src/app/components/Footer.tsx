...
const Footer: React.FC = () => {
  ...
  const email = "gminteriors474@gmail.com";
  const address = "35/9, Betaspace, Desabandhu Street, Ram Nagar, Coimbatore - 641009";
    ...
    <footer className="relative bg-gray-900 text-white">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-amber-400 transition-colors" aria-label="WhatsApp">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} G&M Interiors. All rights reserved.</p>
        </div>
      </div>
